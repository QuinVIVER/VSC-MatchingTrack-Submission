mkdir -p ./feature/train_v1_swin_s3_512_twolosses_com_L2_norm_100_all_tune_bw_gt_ng_1_cls_FIN_test
CUDA_VISIBLE_DEVICES=0 python extract_feature.py \
      --image_dir /data/dataset_val/reference_one_second_ff_v2 \
      --o ./feature/train_v1_swin_s3_512_twolosses_com_L2_norm_100_all_tune_bw_gt_ng_1_cls_FIN_test/reference_v1_ff.hdf5 \
